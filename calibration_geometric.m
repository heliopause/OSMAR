function [] = calibration_geometric(imageInputDirectory,imageOutputDirectory,setColor)
% CALIBRATION_GEOMETRIC Perform geometric calibration (undistortion) based
% on input images with mirror as sample
% 
...
%
% Examples:
% [calibration_geometric('inputDir','workingDir','clr')
% 
% See also:
% CALIBRATION_GEOMETRIC_*
